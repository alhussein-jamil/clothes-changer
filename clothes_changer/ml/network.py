...
class REBNCONV(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Forward pass of the REBNCONV module.
...
def _upsample_like(src: torch.Tensor, tar: torch.Tensor) -> torch.Tensor:
    """Upsample the source tensor to have the same spatial size as the target tensor.

    Args:
        src: The source tensor.
        tar: The target tensor.
...
class RSU7(nn.Module):
    ...
    def __init__(self, in_ch: int = 3, mid_ch: int = 12, out_ch: int = 3) -> None:
        ...
        Args:
            in_ch: The number of input channels.
            mid_ch: The number of middle channels.
            out_ch: The number of output channels.
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Forward pass of the RSU-7 module.
...
class RSU6(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Forward pass of the RSU-6 module.
...
class RSU5(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Forward pass of the RSU-5 module.
...
class RSU4(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Forward pass of the RSU-4 module.
...
class RSU4F(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """Forward pass of the RSU-4F module.
...
class U2NETP(nn.Module):
    ...
    def __init__(self, in_ch: int = 3, out_ch: int = 1) -> None:
        """Initialize the U^2-Net small model.
    ...
    def forward(self, x: torch.Tensor) -> tuple[torch.Tensor, ...]:
        """Forward pass of the U^2-Net small model.
