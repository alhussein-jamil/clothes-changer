"""Colorful terminal logging for Clothes Changer."""
...
_MODULE_STYLES: dict[str, str] = {
    "clothes_changer.ml": "\033[96m",  # bright cyan
    "clothes_changer.ui": "\033[95m",  # bright magenta
    "clothes_changer.db": "\033[93m",  # bright yellow
    "clothes_changer.utils": "\033[94m",  # bright blue
    "clothes_changer.config": "\033[90m",  # gray
    "clothes_changer.content_config": "\033[90m",
    "clothes_changer.scripts": "\033[92m",  # bright green
}
...
def _short_module(name: str) -> str:
    if name.startswith("clothes_changer."):
        return name[len("clothes_changer.") :]
    return name
